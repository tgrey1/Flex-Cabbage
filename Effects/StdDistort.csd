...
Simple modified tanh waveshape distortion using distort1 opcode and 2 filter bands
...
***************/
<Cabbage>
form size(380, 638), caption("StdDistort"), pluginID("tsd1"), import("includes/color_scheme.csd","plants/flexclip.xml","plants/test_audio.xml","plants/collapse.xml","plants/flexpan.xml","plants/flexfilt.xml", "plants/flexfilt_reset.xml", "plants/flexfilt_warn.xml"), $ROOT
...
groupbox $BOX bounds(10, 268, 360, 186), text("Distort") {
  rslider $GREEN_KNOB bounds(0, 35, 130, 130), channel("NegShape"), range(0, 100, 0, 1, 0.1), text("Neg Shape"), popupprefix("Negative Shape:\n"), popuppostfix(" %"), valuetextbox(1)
  rslider $GREEN_KNOB bounds(115, 35, 130, 130), channel("PosShape"), range(0, 100, 0, 1, 0.1), text("Pos Shape"), popupprefix("Positive Shape:\n"), popuppostfix(" %"), valuetextbox(1)
  rslider $BLUE_KNOB bounds(230, 35, 130, 130), channel("mix"), range(0, 100, 100, 1, 0.01), text("Mix"), popupprefix("Mix: "), popuppostfix(" %"), valuetextbox(1)
}
...
instr Effect
  ...
  kPosShape = .1*chnget:k("PosShape")
  kNegShape = .1*chnget:k("NegShape")
  ...
  aDistL	distort1	aSigL, 1, 1, kPosShape, kNegShape, 1
  aDistR	distort1	aSigR, 1, 1, kPosShape, kNegShape, 1

  aSigL ntrpol aSigL, aDistL, kMix
  aSigR ntrpol aSigR, aDistR, kMix
